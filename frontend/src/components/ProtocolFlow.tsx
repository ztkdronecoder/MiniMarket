...
const PHASES = [
  {
    ...
    flow: [
      ...
      { node: 'MiniMarket.sol',       action: 'MarketCreated · EncryptedSubmission events' },
  ...
  },
  {
    ...
    flow: [
      ...
      { node: 'MiniMarket.sol',      action: 'Phase1Resolved event' },
      { node: 'Ponder Indexer' },
    ] as FlowStep[],
  },
  {
    ...
    flow: [
      ...
      { node: 'MiniMarket.sol', action: 'Phase2Resolved event' },
      { node: 'Ponder Indexer' },
    ] as FlowStep[],
  },
] as const;
